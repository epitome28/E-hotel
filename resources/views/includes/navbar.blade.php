<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl noprint" id="navbarBlur" data-scroll="true">
      ...
      <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
        ...
        <ul class="navbar-nav  justify-content-end">
          ...
          <li class="nav-item px-3 d-flex align-items-center">
            <a href="javascript:;" class="noprint nav-link text-body p-0">
